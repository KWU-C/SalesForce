 ...
 * 2026-09-18）。そのため`data/Member.numbers`（属性列がCR1〜4のメンバー一覧、
 * ユーザー提供。旧`Member.xlsx`は廃止・統合済み、2026-09-18）を集計した値を、
 * いったん定数として設定する（ユーザー確定、2026-09-18。「新しい人数マスタは
 * 作らない」という指示のもと、人事異動があった場合はこの値を手動で更新する運用とする）。
 */
